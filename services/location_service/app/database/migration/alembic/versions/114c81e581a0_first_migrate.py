...
Revision ID: 114c81e581a0
Revises: 
Create Date: 2023-01-22 10:37:35.375251
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_locations_image_name'), 'locations', ['image_name'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_locations_image_name'), table_name='locations')
